...
url <- "https://raw.githubusercontent.com/madelarambelje/Cell_Cell/andre/visualizations/heatmap.png"
```
...
```{r, echo=FALSE}
# Define variable containing url
url <- "https://github.com/madelarambelje/Cell_Cell/raw/andre/visualizations/heatmap_raw_count.png"
```
...
```{r, echo=FALSE}
# Define variable containing url
url <- "https://raw.githubusercontent.com/madelarambelje/Cell_Cell/andre/visualizations/network.png"
```
